...
const MUSICIANS = [
  ...
  { name: "Shrub", time: "4:00 PM – 4:45 PM", location: "Main Stage", mapImage: "assets/mainstage-map.png" },
  {
    ...
    mapImage: "assets/mainstage-map.png",
    setlist: [
      { title1: "America, The Beautiful", composer: "Samuel Augustus Ward, Arranged by Carmen Dragon" },
      ...
      { title1: "October", composer: "Eric Whitacre" },
      { title1: "A Fifth of Beethoven", title2: 'As featured in "Mrs. America."', composer: "By Walter Murphy, Arranged by John Ivor Holland" },
      { title1: "Fable", composer: "Erik Morales" },
      { title1: "Spy Chase", composer: "Brant Karrick" },
      { title1: "Sea Songs", composer: "R. Vaughan Williams" },
      { title1: "Stars and Stripes", composer: "John Philip Sousa" },
    ],
  },
];
